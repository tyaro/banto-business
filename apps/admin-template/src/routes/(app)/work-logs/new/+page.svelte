<script lang="ts">
	/**
	 * work-logs の新規作成（docs/recipes/add-resource.md 手順8）。
	...
	import { loadProjectOptions, loadWorkCategoryOptions } from '$lib/banto/referenceOptions.svelte';
	...
	// 案件・作業分類の選択肢（`referenceOptions`）。画面を開くたびに読み直す
