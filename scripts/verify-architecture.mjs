...
// 2026-07-21）。desktop-only / read の判断を変えるときはここを更新する。
{
	...
	const DUAL_PATH = [
		...
		{ tauri: 'customers_delete', rest: 'DELETE /api/customers/{id}', role: 'Editor' },
		{ tauri: 'projects_create', rest: 'POST /api/projects', role: 'Editor' },
		{ tauri: 'projects_update', rest: 'PUT /api/projects/{id}', role: 'Editor' },
		{ tauri: 'projects_delete', rest: 'DELETE /api/projects/{id}', role: 'Editor' },
		// Business ドメイン（Phase 3 工数・経費、docs/domain/schema.md §1・§3）
		{ tauri: 'cost_rates_update', rest: 'PUT /api/cost_rates/{id}', role: 'Editor' },
		{ tauri: 'work_logs_create', rest: 'POST /api/work_logs', role: 'Editor' },
		{ tauri: 'work_logs_update', rest: 'PUT /api/work_logs/{id}', role: 'Editor' },
		{ tauri: 'work_logs_delete', rest: 'DELETE /api/work_logs/{id}', role: 'Editor' },
		{ tauri: 'expenses_create', rest: 'POST /api/expenses', role: 'Editor' },
		{ tauri: 'expenses_update', rest: 'PUT /api/expenses/{id}', role: 'Editor' },
		{ tauri: 'expenses_delete', rest: 'DELETE /api/expenses/{id}', role: 'Editor' },
		{ tauri: 'trips_create', rest: 'POST /api/trips', role: 'Editor' },
		{ tauri: 'trips_update', rest: 'PUT /api/trips/{id}', role: 'Editor' },
		{ tauri: 'trips_delete', rest: 'DELETE /api/trips/{id}', role: 'Editor' },
