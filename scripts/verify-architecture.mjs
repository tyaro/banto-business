...
// 2026-07-21）。desktop-only / read の判断を変えるときはここを更新する。
{
	...
	const DUAL_PATH = [
		...
		{ tauri: 'cost_rates_set', rest: 'PUT /api/cost-rates', role: 'Editor' },
		{ tauri: 'work_logs_create', rest: 'POST /api/work-logs', role: 'Editor' },
		{ tauri: 'work_logs_update', rest: 'PUT /api/work-logs/{id}', role: 'Editor' },
		{ tauri: 'work_logs_delete', rest: 'DELETE /api/work-logs/{id}', role: 'Editor' },
